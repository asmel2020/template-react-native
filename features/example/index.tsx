...
export default function ExampleScreen() {
  ...
  return (
    ...
    >
      ...
      <Section
        title="Overlays"
        hint="Both render through the provider's portal."
      >
        <View className="gap-2">
      ...
      <Section
        title="Form"
        hint="Labels, descriptions and error states included."
      >
        <Card>
      ...
      <Section
        title="Rows"
        hint="Item is the settings-list and the list-row shape."
      >
        <Card>
          <Item>
            <Item.Media>
          ...
          <Item>
            <Item.Content>
              ...
              <Item.Description>
                Push alerts for anything urgent
              </Item.Description>
            </Item.Content>
            <Item.Actions>
              <Switch
        ...
        <Card>
          <Accordion defaultValue="what">
            <Accordion.Item value="what">
              ...
              <Accordion.Content>
                <Text size="sm" muted>
                  Three screens, a native tab bar, and the theme wired up.
                  Nothing you have to keep.
                </Text>
              </Accordion.Content>
            </Accordion.Item>
      ...
      <Section
        title="Loading"
        hint="Skeletons keep the layout while data arrives."
      >
        <Card>
